<?
	...
	$result= mysql_query ("SELECT *  FROM PAZIENTI");
	$i=0;
?> 
...
<th id=\"eta\"> Eta <span style="float:right"class="btn btn-primary btn-xs glyphicon glyphicon-asterisk" onclick="mostra_eta_pazienti()"></span></th> 
